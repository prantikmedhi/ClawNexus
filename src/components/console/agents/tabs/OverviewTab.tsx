      ...
      <div className="border-t border-gray-200 pt-5 dark:border-gray-700">
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <button
              onClick={addFallback}
              className="flex items-center gap-1 text-xs text-orange-500 hover:text-orange-600 dark:text-orange-400"
            >
  ...
  return (
    <div className="relative w-full">
      <select
        ...
        className="w-full appearance-none rounded-lg border border-gray-300 bg-white px-3 py-2 pr-8 text-sm text-gray-900 focus:border-orange-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200"
      >
