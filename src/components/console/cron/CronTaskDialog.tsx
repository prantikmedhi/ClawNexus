            ...
            <div className="mb-3 flex flex-wrap gap-2">
              {CRON_PRESETS.map((preset, i) => (
                <button
                  ...
                  className={`rounded-md border px-3 py-1.5 text-xs font-medium transition-colors ${selectedPreset === i ? "border-orange-500 bg-orange-50 text-orange-600 dark:border-orange-400 dark:bg-orange-900/20 dark:text-orange-400" : "border-gray-300 text-gray-600 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-400 dark:hover:bg-gray-700"}`}
                >
                  {t(preset.labelKey)}
                </button>
              ))}
