        ...
        <div className="space-y-4 border-t border-gray-200 px-4 py-4 dark:border-gray-600">
          ...
          <div>
            <button
              ...
              className="flex items-center gap-1 text-xs text-orange-500 hover:underline dark:text-orange-400"
            >
    ...
    <div>
      <div className="mb-3 flex items-center justify-between">
        ...
        <button
          type="button"
          onClick={handleAdd}
          className="flex items-center gap-1 rounded-lg border border-dashed border-gray-300 px-3 py-1.5 text-xs text-gray-600 hover:border-orange-400 hover:text-orange-500 dark:border-gray-500 dark:text-gray-400 dark:hover:border-orange-400 dark:hover:text-orange-400 transition-colors"
        >
...
const inputCls =
  "w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-400/20 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 transition-colors";

const selectCls =
  "w-full appearance-none rounded-lg border border-gray-300 bg-white px-3 py-2 pr-8 text-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-400/20 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 transition-colors";
  ...
  return (
    <button
      ...
      className={`flex items-center gap-1.5 rounded-lg border px-3 py-2 text-xs font-medium transition-colors ${
        active
          ? "border-orange-500 bg-orange-50 text-orange-600 dark:border-orange-400 dark:bg-orange-900/20 dark:text-orange-300"
