            ...
            <div className="mt-6 grid grid-cols-3 gap-3 sm:grid-cols-4">
              {PROVIDER_TYPE_INFO.map((meta) => (
                <button
                  ...
                  className="flex flex-col items-center gap-2 rounded-xl border border-gray-200 px-4 py-5 text-center hover:border-orange-400 hover:bg-orange-50/80 dark:border-gray-600 dark:hover:border-orange-500 dark:hover:bg-orange-900/20 transition-all"
                >
          ...
          <div>
            ...
            <div className="mt-8 flex justify-end gap-3">
              ...
              <button
                ...
                disabled={!canSave}
                className="rounded-lg bg-orange-500 px-5 py-2.5 text-sm font-medium text-white hover:bg-orange-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
              ...
              <button
                ...
                disabled={!canSave}
                className="rounded-lg border border-orange-200 px-5 py-2.5 text-sm font-medium text-orange-600 hover:bg-orange-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors dark:border-orange-800 dark:text-orange-300 dark:hover:bg-orange-900/20"
              >
...
const inputCls =
  "w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-400/20 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 transition-colors";

const selectCls =
  "w-full appearance-none rounded-lg border border-gray-300 bg-white px-4 py-2.5 pr-10 text-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-400/20 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 transition-colors";
