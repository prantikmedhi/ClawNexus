      ...
      {subAgents.map((sub) => {
        ...
        return (
          <button
            ...
            className="flex w-full items-start gap-2 border-b border-gray-50 px-3 py-2 text-left transition-colors hover:bg-orange-50 dark:border-gray-800 dark:hover:bg-orange-950"
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              {parent && (
                <span
                  ...
                  className="cursor-pointer text-[10px] text-orange-500 hover:underline"
                >
                  ← {parent.name}
                </span>
              )}
