      ...
      >
        <div className="border-b border-gray-100 px-3 py-1.5 dark:border-gray-800">
          <input
            ...
            className="w-full rounded border border-gray-200 bg-gray-50 px-2 py-1 text-sm text-gray-800 placeholder-gray-400 outline-none focus:border-orange-400 focus:ring-1 focus:ring-orange-400 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 dark:placeholder-gray-500"
          />
          ...
          {agentList.map((agent) => (
            <button
              ...
              className={`flex w-full items-center gap-3 border-b border-gray-50 px-3 py-2 text-left transition-colors hover:bg-gray-50 dark:border-gray-800 dark:hover:bg-gray-800 ${
                selectedAgentId === agent.id ? "bg-orange-50 dark:bg-orange-950" : ""
              }`}
            >
...
function AgentSearchBadge({
  ...
  return (
    <span className="rounded bg-orange-100 px-1 text-[9px] text-orange-600 dark:bg-orange-900/30 dark:text-orange-300">
      {label}
    </span>
  );
}
